...
import { Segment, Form, Button, Grid, Loader, Container } from 'semantic-ui-react';
import { createNewAccount } from '../../../../redux/actions/create';
import LocationForm from '../Locations/createLocation'
...
export default connect(null, actions)(NewAccountForm);
